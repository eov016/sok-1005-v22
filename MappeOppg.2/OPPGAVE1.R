...
#Etter å ha funnet json filen fra NY-times ved å lese gjennom sidekilden, lastet
#jeg opp linken. Deretter gjorde jeg den om til df slik jeg ville ha den.
...
#Konverterer til numeric, som etter as_tibble() blir double (numeric)
...
#Forsøkte å finne en måte å forkorte navnene på, men konkluderte med å bare endre
#på de en etter en før ggplot.
...
#Fulgte NY-times sin graf, forsøkte å replisere den. Fikk med alt og tok meg noen friheter.
