...
#Jeg tolker dette som at ca. 63.34% av befolkningen er full-vaksinert, altså er -36.66 % ikke full-vaksinert. 
#Det er veldig tydelig at med høyere vaksinasjons rate er det lavere dødstall pr. 100K.
#Basert på disse data, tolker jeg det som at tallene "31.15" er antall døde pr 100K statene samlet.
#Altså, er tallet på antall døde i dette tilfelle ca. 31 150 per 100K den perioden.
